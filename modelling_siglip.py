...
#Visual Transformer for PaliGemma
class SiglipVisionConfig:
    ...
    def __init__(
        ...
        hidden_size=768,
        # size of the linear layer in the feedforward network
        intermediate_size=3072,
        # number of layers in the visual transformer
        num_hidden_layers=12,
        # number of attention heads in the visual transformer 
        num_attention_heads=12,
        # number of channels in the input image (3 for RGB) 
        num_channels=3,
        # size of the input image (image_size x image_size) in pixels (224 for 224x224), PALIGEMMA also comes in different sizes
        image_size=224,
        # size of the patch (patch_size x patch_size) in pixels (16 for 16x16)
        patch_size=16,
        # epsilon value for layer normalization in the visual transformer
        layer_norm_eps=1e-6,
        # dropout rate for the attention layer in the visual transformer
        attention_dropout=0.0,
        # number of image tokens in the visual transformer
...
class SiglipVisionTransformer(nn.Module):
    def __init__(self, config: SiglipVisionConfig):
        ...
        # Embeddings for the image, this includes a convolution layer and a linear projection layer
        self.embeddings = SiglipVisionEmbeddings(config)
        # List of visual transformer layers
...
class SiglipVisionModel(nn.Module):
    ...
    def forward(self, pixel_values) -> Tuple:
        # Image_Values: [Channels, Height, Width]
